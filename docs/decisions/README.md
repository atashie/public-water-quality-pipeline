...
|---|---|---|---|
| [0001](0001-scope-conventions-and-dataset-order.md) | Scope, conventions, dataset order, and the per-dataset loop | 2026-09-22 | active |
| [0002](0002-per-lake-table-recipe.md) | The per-lake table: lake universe, pixel rule, and statistics | 2026-09-23 | active, owner confirmation of the recipe pending |
