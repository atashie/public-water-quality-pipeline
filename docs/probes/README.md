...
|---|---|---|
| 2026-09-22 | [Dataset facts checked before initialization](2026-09-22-dataset-facts.md) | CyAN catalogs and cloud bucket, Copernicus catalog listing and manual, EPA forecast page and evaluation abstract |
...
| 2026-09-25 | [The SFEI harmful algal bloom map surveyed through its public documentation](2026-09-25-sfei-fhab-survey.md) | The map behind a bot check, its interface documentation and named levels, gap handling, the state's best-practices report, and candidate features |
