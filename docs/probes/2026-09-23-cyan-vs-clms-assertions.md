...
| A2. The algorithm reads the spectral shape around 665 and 681 nm, responding to chlorophyll fluorescence and absorption, and uses a phycocyanin feature to separate cyanobacteria | Confirmed, with one omission. The shape is centred at 681 nm with 665 and 709 nm as the reference bands. The cyanobacteria test is a second shape at 620, 665, and 681 nm keyed to phycocyanin absorption at 620 nm |
